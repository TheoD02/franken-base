 ...
 */
#[ORM\Entity]
#[ApiResource(types: ['https://schema.org/DataCatalog'])]
class DataCatalog extends CreativeWork
{
    ...
    #[ORM\JoinTable(name: 'data_catalog_defined_term_measurement_technique')]
     ...
     */
    #[ORM\OneToOne(targetEntity: 'App\Entity\Dataset')]
    #[ORM\JoinColumn(nullable: false)]
    #[ApiProperty(types: ['https://schema.org/dataset'])]
    #[Assert\NotNull]
