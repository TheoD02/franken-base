...
trait ApiServiceProviderTrait
{
    protected ApiMapperInterface $apiMapper;
    protected ApiCollectionMapperInterface $apiCollectionMapper;

//    protected TokenStorageInterface $tokenStorage;
    protected AuthorizationCheckerInterface $authorizationChecker;

    #[Required]
    public function setApiMapper(ApiMapperInterface $apiMapper): void
    {
        $this->apiMapper = $apiMapper;
    }

    #[Required]
    public function setApiCollectionMapper(ApiCollectionMapperInterface $apiCollectionMapper): void
    {
    ...
    protected function createAccessDeniedException(string $message = 'Access Denied.', \Throwable $previous = null): AccessDeniedException
    {
        if (!class_exists(AccessDeniedException::class)) {
            throw new \LogicException(
                'You cannot use the "createAccessDeniedException" method if the Security component is not available. Try running "composer require symfony/security-bundle".'
            );
        }
