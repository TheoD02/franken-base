...
#[\Symfony\Component\Console\Attribute\AsCommand(name: 'castor:debug', description: 'Debug the application', hidden: true, aliases: ['debug'])]
final class DebugCommand extends \Symfony\Component\Console\Command\Command
{
    public function __construct(private readonly string $rootDir, private readonly string $cacheDir, private readonly \Castor\ContextRegistry $contextRegistry)
    {
    }
...
{
    public function __construct(public readonly \Castor\Console\Application $application, public \Castor\TaskDescriptorCollection $taskDescriptorCollection)
    {
    }
}
namespace Castor\Event;
 ...
 * @param array<string, string|\Stringable|int>|null $environment
 */
function with(callable $callback, ?array $data = null, ?array $environment = null, ?string $path = null, ?bool $tty = null, ?bool $pty = null, ?float $timeout = null, ?bool $quiet = null, ?bool $allowFailure = null, ?bool $notify = null, Context|string|null $context = null) : mixed
{
}
/**
 * @see https://www.php.net/manual/en/function.hash-algos.php
